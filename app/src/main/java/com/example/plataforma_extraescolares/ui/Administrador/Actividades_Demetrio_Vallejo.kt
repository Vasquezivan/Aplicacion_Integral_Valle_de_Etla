...
class Actividades_Demetrio_Vallejo : AppCompatActivity() {
    ...
    // ===== 1. DECLARACIONES DE VISTAS (misma estructura, nombres idénticos) =====
    private lateinit var botonEditar: MaterialButton
    // La declaración de botonEliminar se queda, pero su inicialización estará comentada
    private lateinit var botonEliminar: MaterialButton
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        // =====> CAMBIO CLAVE: Usar el layout correcto
        ...
        // Los IDs son los mismos en ambos layouts, por lo que esta sección es idéntica
        botonEditar = findViewById(R.id.botonEditar)
        // botonEliminar = findViewById(R.id.botonEliminar) // Mantenemos comentada la inicialización
        ...
        // Esta lógica es genérica y no necesita cambios.
        ...
        // ================================================================
        // ===== INICIO DEL BLOQUE DE ELIMINAR COMENTADO CORRECTAMENTE ====
        // ================================================================
        /*
        ...
        botonEliminar.setOnClickListener {
            ...
            when {
                checkEstudiante1.isChecked -> {
                    ...
                    mostrarDialogoDeConfirmacion(1, nombre) // Pasamos el número 1
                }
                checkEstudiante2.isChecked -> {
                    nombre = nombreEstudiante2.text.toString()
                    mostrarDialogoDeConfirmacion(2, nombre) // Pasamos el número 2
                }
                else -> {
        ...
        */
        // ==============================================================
        // ===== FIN DEL BLOQUE DE ELIMINAR COMENTADO CORRECTAMENTE =====
        // ==============================================================
    }

    // =========================================================================
    // ===== INICIO DEL BLOQUE DE FUNCIONES DE ELIMINAR COMENTADAS (OPCIONAL) ====
    // =========================================================================
    /*
    // Función para el diálogo de confirmación
    ...
    // Función que realiza la eliminación visual
    ...
    */
    // =======================================================================
    // ===== FIN DEL BLOQUE DE FUNCIONES DE ELIMINAR COMENTADAS (OPCIONAL) =====
    // =======================================================================

    /**
     * Función que crea y muestra el diálogo modal para editar un estudiante.
     * Esta función es idéntica y reutilizable.
     */
    private fun showEditDialog(nombre: String, noControl: String, carrera: String, semestre: String, checkBoxSeleccionado: CheckBox) {
        ...
        // =====> CAMBIO CLAVE: El diálogo de edición es el mismo, no necesita cambio
